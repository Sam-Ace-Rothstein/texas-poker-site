import{z as we,B as ue,D as pe,i as f,r as _,d as g,x as a,F as L,e as re,y as se,R as l,v,j as X,n as me,G as k,k as he,g as oe,H as G,M as h,O as E,C as q,I as ae,p as A,A as U,o as ve,J as fe,f as ge,m as be}from"./account-xoFCU8pe.js";import{c as u,n as w,r as d,o as F,U as ye}from"./index-cNsw-A7n.js";/* empty css                 */const m=we({message:"",open:!1,triggerRect:{width:0,height:0,top:0,left:0},variant:"shade"}),O={state:m,subscribe(s){return pe(m,()=>s(m))},subscribeKey(s,e){return ue(m,s,e)},showTooltip({message:s,triggerRect:e,variant:t}){m.open=!0,m.message=s,m.triggerRect=e,m.variant=t},hide(){m.open=!1,m.message="",m.triggerRect={width:0,height:0,top:0,left:0}}},xe=f`
  :host {
    display: block;
...
`;var ce=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};const Ne={info:{backgroundColor:"fg-350",iconColor:"fg-325",icon:"info"},success:{backgroundColor:"success-glass-reown-020",iconColor:"success-125",icon:"checkmark"},warning:{backgroundColor:"warning-glass-reown-020",iconColor:"warning-100",icon:"warningCircle"},error:{backgroundColor:"error-glass-reown-020",iconColor:"error-125",icon:"exclamationTriangle"}};let z=class extends g{constructor(){super(),this.unsubscribe=[],this.open=L.state.open,this.onOpen(!0),this.unsubscribe.push(L.subscribeKey("open",e=>{this.open=e,this.onOpen(!1)}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){const{message:e,variant:t}=L.state,o=Ne[t];return a`
      ...
      ></wui-alertbar>
    `}onOpen(e){this.open?(this.animate([{opacity:0,transform:"scale(0.85)"},{opacity:1,transform:"scale(1)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: auto"):e||(this.animate([{opacity:1,transform:"scale(1)"},{opacity:0,transform:"scale(0.85)"}],{duration:150,fill:"forwards",easing:"ease"}),this.style.cssText="pointer-events: none")}};z.styles=Se;ce([d()],z.prototype,"open",void 0);z=ce([u("w3m-alertbar")],z);const Re=f`
  button {
...
`,a`
    ...
    `}};N.styles=[_,re,se,Re];B([w()],N.prototype,"size",void 0);B([w({type:Boolean})],N.prototype,"disabled",void 0);B([w()],N.prototype,"icon",void 0);B([w()],N.prototype,"iconColor",void 0);N=B([u("wui-icon-link")],N);const We=f`
  button {
    display: block;
    display: flex;
    align-items: center;
...
`;var le=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let H=class extends g{constructor(){super(...arguments),this.imageSrc=""}render(){return a`<button>
    ...
    ></wui-icon-box>`}};H.styles=[_,re,se,We];le([w()],H.prototype,"imageSrc",void 0);H=le([u("wui-select")],H);const $e=f`
  :host {
    height: 64px;
  }
...
`;var b=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};const Te=["SmartSessionList"];function Y(){var r,c,T,C,j,M,V;const s=(c=(r=l.state.data)==null?void 0:r.connector)==null?void 0:c.name,e=(C=(T=l.state.data)==null?void 0:T.wallet)==null?void 0:C.name,t=(M=(j=l.state.data)==null?void 0:j.network)==null?void 0:M.name,o=e??s,n=q.getConnectors();return{Connect:`Connect ${n.length===1&&((V=n[0])==null?void 0:V.id)==="w3m-email"?"Email":""} Wallet`,Create:"Create Wallet",ChooseAccountName:void 0,Account:void 0,AccountSettings:void 0,AllWallets:"All Wallets",ApproveTransaction:"Approve Transaction",BuyInProgress:"Buy",ConnectingExternal:o??"Connect Wallet",ConnectingWalletConnect:o??"WalletConnect",ConnectingWalletConnectBasic:"WalletConnect",ConnectingSiwe:"Sign In",Convert:"Convert",ConvertSelectToken:"Select token",ConvertPreview:"Preview convert",Downloads:o?`Get ${o}`:"Downloads",EmailLogin:"Email Login",EmailVerifyOtp:"Confirm Email",EmailVerifyDevice:"Register Device",GetWallet:"Get a wallet",Networks:"Choose Network",OnRampProviders:"Choose Provider",OnRampActivity:"Activity",OnRampTokenSelect:"Select Token",OnRampFiatSelect:"Select Currency",Profile:void 0,SwitchNetwork:t??"Switch Network",SwitchAddress:"Switch Address",Transactions:"Activity",UnsupportedChain:"Switch Network",UpgradeEmailWallet:"Upgrade your Wallet",UpdateEmailWallet:"Edit Email",UpdateEmailPrimaryOtp:"Confirm Current Email",UpdateEmailSecondaryOtp:"Confirm New Email",WhatIsABuy:"What is Buy?",RegisterAccountName:"Choose name",RegisterAccountNameSuccess:"",WalletReceive:"Receive",WalletCompatibleNetworks:"Compatible Networks",Swap:"Swap",SwapSelectToken:"Select token",SwapPreview:"Preview swap",WalletSend:"Send",WalletSendPreview:"Review send",WalletSendSelectToken:"Select Token",WhatIsANetwork:"What is a network?",WhatIsAWallet:"What is a wallet?",ConnectWallets:"Connect wallet",ConnectSocials:"All socials",ConnectingSocial:ae.state.socialProvider?ae.state.socialProvider:"Connect Social",ConnectingMultiChain:"Select chain",ConnectingFarcaster:"Farcaster",SwitchActiveChain:"Switch chain",SmartSessionCreated:void 0,SmartSessionList:"Smart Sessions",SIWXSignMessage:"Sign In"}}let p=class extends g{constructor(){super(),this.unsubscribe=[],this.heading=Y()[l.state.view],this.network=v.state.activeCaipNetwork,this.networkImage=X.getNetworkImage(this.network),this.buffering=!1,this.showBack=!1,this.prevHistoryLength=1,this.view=l.state.view,this.viewDirection="",this.headerText=Y()[l.state.view],this.unsubscribe.push(me.subscribeNetworkImages(()=>{this.networkImage=X.getNetworkImage(this.network)}),l.subscribeKey("view",e=>{setTimeout(()=>{this.view=e,this.headerText=Y()[e]},k.ANIMATION_DURATIONS.HeaderText),this.onViewChange(),this.onHistoryChange()}),he.subscribeKey("buffering",e=>this.buffering=e),v.subscribeKey("activeCaipNetwork",e=>{this.network=e,this.networkImage=X.getNetworkImage(this.network)}))}disconnectCallback(){this.unsubscribe.forEach(e=>e())}render(){return a`
    ...
    ></wui-icon-link>`}onNetworks(){this.isAllowedNetworkSwitch()&&(oe.sendEvent({type:"track",event:"CLICK_NETWORKS"}),l.push("Networks"))}isAllowedNetworkSwitch(){const e=v.getAllRequestedCaipNetworks(),t=e?e.length>1:!1,o=e==null?void 0:e.find(({id:n})=>{var i;return n===((i=this.network)==null?void 0:i.id)});return t||!o}getPadding(){return this.heading?["l","2l","l","2l"]:["0","2l","0","2l"]}onViewChange(){const{history:e}=l.state;let t=k.VIEW_DIRECTION.Next;e.length<this.prevHistoryLength&&(t=k.VIEW_DIRECTION.Prev),this.prevHistoryLength=e.length,this.viewDirection=t}async onHistoryChange(){var o;const{history:e}=l.state,t=(o=this.shadowRoot)==null?void 0:o.querySelector("#dynamic");e.length>1&&!this.showBack&&t?(await t.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!0,t.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"})):e.length<=1&&this.showBack&&t&&(await t.animate([{opacity:1},{opacity:0}],{duration:200,fill:"forwards",easing:"ease"}).finished,this.showBack=!1,t.animate([{opacity:0},{opacity:1}],{duration:200,fill:"forwards",easing:"ease"}))}onGoBack(){l.goBack()}};p.styles=$e;b([d()],p.prototype,"heading",void 0);b([d()],p.prototype,"network",void 0);b([d()],p.prototype,"networkImage",void 0);b([d()],p.prototype,"buffering",void 0);b([d()],p.prototype,"showBack",void 0);b([d()],p.prototype,"prevHistoryLength",void 0);b([d()],p.prototype,"view",void 0);b([d()],p.prototype,"viewDirection",void 0);b([d()],p.prototype,"headerText",void 0);p=b([u("w3m-header")],p);const Ae=f`
  :host {
    display: flex;
...
`;var W=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let y=class extends g{constructor(){super(...arguments),this.backgroundColor="accent-100",this.iconColor="accent-100",this.icon="checkmark",this.message="",this.loading=!1,this.iconType="default"}render(){return a`
      ${this.templateIcon()}
    ...
    `}templateIcon(){return this.loading?a`<wui-loading-spinner size="md" color="accent-100"></wui-loading-spinner>`:this.iconType==="default"?a`<wui-icon size="xl" color=${this.iconColor} name=${this.icon}></wui-icon>`:a`<wui-icon-box
      ...
      icon=${this.icon}
      background="opaque"
    ></wui-icon-box>`}};y.styles=[_,Ae];W([w()],y.prototype,"backgroundColor",void 0);W([w()],y.prototype,"iconColor",void 0);W([w()],y.prototype,"icon",void 0);W([w()],y.prototype,"message",void 0);W([w()],y.prototype,"loading",void 0);W([w()],y.prototype,"iconType",void 0);y=W([u("wui-snackbar")],y);const Oe=f`
  :host {
    display: block;
    position: absolute;
    opacity: 0;
...
`;var D=function(s,e,t,o){var n=arguments.length,i=n<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(s,e,t,o);else for(var c=s.length-1;c>=0;c--)(r=s[c])&&(i=(n<3?r(i):n>3?r(e,t,i):r(e,t))||i);return n>3&&i&&Object.defineProperty(e,t,i),i};let R=class extends g{constructor(){super(),this.unsubscribe=[],this.open=O.state.open,this.message=O.state.message,this.triggerRect=O.state.triggerRect,this.variant=O.state.variant,this.unsubscribe.push(O.subscribe(e=>{this.open=e.open,this.message=e.message,this.triggerRect=e.triggerRect,this.variant=e.variant}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){this.dataset.variant=this.variant;const e=this.triggerRect.top,t=this.triggerRect.left;return this.style.cssText=`
    ...
    </wui-flex>`}};R.styles=[Ie];D([d()],R.prototype,"open",void 0);D([d()],R.prototype,"message",void 0);D([d()],R.prototype,"triggerRect",void 0);D([d()],R.prototype,"variant",void 0);R=D([u("w3m-tooltip"),u("w3m-tooltip")],R);const _e=f`
  :host {
    --prev-height: 0px;
    --new-height: 0px;
    display: block;
